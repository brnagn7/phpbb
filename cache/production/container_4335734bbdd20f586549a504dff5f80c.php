...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_000000003b57563c00007f909db1ab08(
...
class phpbbtemplatetwiglexer_000000003b57563c00007f909db1ab08 extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder58a77330f3c0c225328320 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer58a77330f3c25854366514 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties58a77330f3bc6624630210 = array(
    ...
    {
        $this->initializer58a77330f3c25854366514 && $this->initializer58a77330f3c25854366514->__invoke($this->valueHolder58a77330f3c0c225328320, $this, 'set_environment', array('env' => $env), $this->initializer58a77330f3c25854366514);

        return $this->valueHolder58a77330f3c0c225328320->set_environment($env);
    }
    ...
    {
        $this->initializer58a77330f3c25854366514 && $this->initializer58a77330f3c25854366514->__invoke($this->valueHolder58a77330f3c0c225328320, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer58a77330f3c25854366514);

        return $this->valueHolder58a77330f3c0c225328320->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer58a77330f3c25854366514 && $this->initializer58a77330f3c25854366514->__invoke($this->valueHolder58a77330f3c0c225328320, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer58a77330f3c25854366514);

        return $this->valueHolder58a77330f3c0c225328320->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer58a77330f3c25854366514 = $initializer;
    }
    ...
    {
        $this->initializer58a77330f3c25854366514 && $this->initializer58a77330f3c25854366514->__invoke($this->valueHolder58a77330f3c0c225328320, $this, '__get', array('name' => $name), $this->initializer58a77330f3c25854366514);

        if (isset(self::$publicProperties58a77330f3bc6624630210[$name])) {
            return $this->valueHolder58a77330f3c0c225328320->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder58a77330f3c0c225328320;
    ...
    {
        $this->initializer58a77330f3c25854366514 && $this->initializer58a77330f3c25854366514->__invoke($this->valueHolder58a77330f3c0c225328320, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer58a77330f3c25854366514);
    ...
    {
        $this->initializer58a77330f3c25854366514 && $this->initializer58a77330f3c25854366514->__invoke($this->valueHolder58a77330f3c0c225328320, $this, '__isset', array('name' => $name), $this->initializer58a77330f3c25854366514);
    ...
    {
        $this->initializer58a77330f3c25854366514 && $this->initializer58a77330f3c25854366514->__invoke($this->valueHolder58a77330f3c0c225328320, $this, '__unset', array('name' => $name), $this->initializer58a77330f3c25854366514);
    ...
    {
        $this->initializer58a77330f3c25854366514 && $this->initializer58a77330f3c25854366514->__invoke($this->valueHolder58a77330f3c0c225328320, $this, '__clone', array(), $this->initializer58a77330f3c25854366514);

        $this->valueHolder58a77330f3c0c225328320 = clone $this->valueHolder58a77330f3c0c225328320;
    }

    public function __sleep()
    {
        $this->initializer58a77330f3c25854366514 && $this->initializer58a77330f3c25854366514->__invoke($this->valueHolder58a77330f3c0c225328320, $this, '__sleep', array(), $this->initializer58a77330f3c25854366514);

        return array('valueHolder58a77330f3c0c225328320');
    }
    ...
    {
        return $this->initializer58a77330f3c25854366514;
    }
    ...
    {
        return $this->initializer58a77330f3c25854366514 && $this->initializer58a77330f3c25854366514->__invoke($this->valueHolder58a77330f3c0c225328320, $this, 'initializeProxy', array(), $this->initializer58a77330f3c25854366514);
    }
    ...
    {
        return null !== $this->valueHolder58a77330f3c0c225328320;
    }
    ...
    {
        return $this->valueHolder58a77330f3c0c225328320;
    }
